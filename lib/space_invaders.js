...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const gameView   = new GameView(ctx, canvasSize, layout);
  ...
  musicOn.addEventListener('click', () => {
    musicOn.className  = 'hide';
    musicOff.className = 'show';
    gameView.toggleBgMusic();
  });

  musicOff.addEventListener('click', () => {
    musicOff.className = 'hide';
    musicOn.className  = '';
    gameView.toggleBgMusic();
  });
